...
1. [什么是 Obsidian 图标库浏览器](#1.%20什么是%20Obsidian%20图标库浏览器)
2. [前提条件与必要插件](#2.%20前提条件与必要插件)
3. [安装与配置步骤](#3.%20安装与配置步骤)
4. [创建图标库浏览器笔记](#4.%20创建图标库浏览器笔记)
5. [界面功能详解](#5.%20界面功能详解)
6. [图标名称格式说明](#6.%20图标名称格式说明)
7. [图标名称的实际应用场景](#7.%20图标名称的实际应用场景)
8. [常见问题排查](#8.%20常见问题排查)
