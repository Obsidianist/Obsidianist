...
10. [同步模式速查：五种同步类型](Obsidian%20同步方案之%20Syncthing.md#10.%20同步模式速查：五种同步类型)
...
Syncthing 的精髓在于每个同步文件夹可以独立配置文件夹类型，这决定了数据在两端之间如何流动。在配置仓库同步之前，先了解这几种模式，可以帮助你在后续步骤中快速理解每一步的意图。
