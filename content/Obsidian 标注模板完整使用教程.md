...
1. [标注块基础：Obsidian Callout 是什么](#1.%20标注块基础：Obsidian%20Callout%20是什么)
2. [前提条件](#2.%20前提条件)
3. [模板文件的放置与配置](#3.%20模板文件的放置与配置)
4. [使用流程：从触发到插入](#4.%20使用流程：从触发到插入)
5. [弹窗界面详解](#5.%20弹窗界面详解)
6. [所有支持的标注类型](#6.%20所有支持的标注类型)
7. [折叠选项说明](#7.%20折叠选项说明)
8. [输出格式解析](#8.%20输出格式解析)
9. [快捷键与效率技巧](#9.%20快捷键与效率技巧)
10. [常见问题与注意事项](#10.%20常见问题与注意事项)
11. [进阶：修改与扩展标注类型](#11.%20进阶：修改与扩展标注类型)
