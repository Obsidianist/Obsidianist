...
1. [方案定位与适用场景](#1.%20方案定位与适用场景)
2. [前提条件](#2.%20前提条件)
3. [在 GitHub 上创建远程仓库](#3.%20在%20GitHub%20上创建远程仓库)
4. [安装 GitHub Desktop 并克隆仓库](#4.%20安装%20GitHub%20Desktop%20并克隆仓库)
5. [在 Obsidian 中打开克隆的仓库](#5.%20在%20Obsidian%20中打开克隆的仓库)
6. [配置 `.gitignore`：排除高频变动文件](#6.%20配置%20`.gitignore`：排除高频变动文件)
7. [桌面端日常工作流：提交与推送](#7.%20桌面端日常工作流：提交与推送)
8. [版本回退：如何找回历史状态](#8.%20版本回退：如何找回历史状态)
9. [移动端初始准备：将仓库传入手机](#9.%20移动端初始准备：将仓库传入手机)
10. [移动端安装与配置 Git 插件](#10.%20移动端安装与配置%20Git%20插件)
11. [生成 GitHub Personal Access Token](#11.%20生成%20GitHub%20Personal%20Access%20Token)
12. [GitHub Desktop 偏好设置](#12.%20GitHub%20Desktop%20偏好设置)
13. [GitHub Desktop 进阶操作](#13.%20GitHub%20Desktop%20进阶操作)
14. [Git 插件设置详解](#14.%20Git%20插件设置详解)
15. [常见问题与排查](#15.%20常见问题与排查)
16. [进阶用法与调整建议](#16.%20进阶用法与调整建议)
17. [平台支持与注意事项](#17.%20平台支持与注意事项)
18. [附录 1：命令行初始化仓库（Git CLI 方案）](#18.%20附录%201：命令行初始化仓库（Git%20CLI%20方案）)
19. [附录 2：搭配 Version History Diff 插件增强历史对比体验](#19.%20附录%202：搭配%20Version%20History%20Diff%20插件增强历史对比体验)
20. [参考资源](#20.%20参考资源)
